...
export default function StorageAccordion({ title, description, link }) {
  const [open, setOpen] = useState(false)

  return (
    <section className="accordion" open={open} onClick={() => setOpen(!open)}>
      <StaticImage
      ...
      <Accordion className="accordion__content" open={open}>
        ...
        <p open={open} className="accordion__info article article--white">
          {description}
        </p>
        <Link
